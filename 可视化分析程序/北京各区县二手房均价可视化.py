...
mycollection = mydatabase["beijing_avg_area"]
list0 = list()
listx = list()
listy = list()
...
bar.set_global_opts(title_opts=opts.TitleOpts(title="北京市各区县二手房均价", subtitle="单位：元/平方米"))
bar.render("C:/Users/Leonard/Desktop/BigDataCourseDesign/htmls/北京各区县均价.html")